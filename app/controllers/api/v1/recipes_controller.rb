module Api::V1
  class RecipesController < ApplicationController
    ...
    def fetch_recipes
      fetch = RestClient.get(YUMMLY_RECIPES_URL + YUMMLY_ID_AND_KEY + ALLOWED_HOLIDAY + NEAREST_HOLIDAY + results(10, params[:q].to_i))
    ...
    def search_recipes
      ...
      fetch = RestClient.get(YUMMLY_RECIPES_URL + YUMMLY_ID_AND_KEY + searchIngredients + results(10, params[:q].to_i))
      results = JSON.parse(fetch)
      render json: results
    end
